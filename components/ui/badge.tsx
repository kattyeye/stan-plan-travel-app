...
const colors = {
  ...
  brand: 'bg-[var(--color-accent)]/15 text-[var(--color-accent-hover)] group-data-hover:bg-[var(--color-accent)]/25',
}
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  let classes = clsx(
    className,
    'group relative inline-flex rounded-md focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-[var(--color-accent)]'
  )
